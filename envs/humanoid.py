...
class Humanoid(PipelineEnv):
    ...
    def reset(self, rng: jax.Array) -> State:
        ...
        metrics = {
            ...
            "success_easy": zero,
            "progress": zero,
            "total_distance": jp.linalg.norm(target - obs[:2]),
        }
        info = {"seed": 0, "original_dist": jp.linalg.norm(target)}
    ...
    def step(self, state: State, action: jax.Array) -> State:
        ...
        progress = jp.maximum((total_distance - dist) / total_distance, progress)
    ...
    def _random_target(self, rng: jax.Array, dist: float):
        rng, rng1, rng2 = jax.random.split(rng, 3)
        dist = dist * jax.random.uniform(rng1)
